((root, factory) => {
  ...
  "use strict";
  const KEY = "xiaoluXiaogNotesV1", SCHEMA_VERSION = 2;
  const CATEGORIES = ["科研", "英语", "C语言", "旅行", "日记", "小路×小G", "其他"];
  const SOURCE_MODULES=["manual","wish","footprint","memory","exercise"];
  ...
  return { KEY, SCHEMA_VERSION, CATEGORIES, SOURCE_MODULES, normalizeNote, normalizeState, load, save };
});
