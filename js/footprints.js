(() => {
  ...
  function renderPlaces() {
    ...
    visible.forEach(item=>{
      ...
      const actions=document.createElement("div");actions.className="card-actions";actions.innerHTML='<button type="button" data-action="edit">✎ 编辑</button><button type="button" class="delete-action" data-action="delete">删除</button>';card.append(actions);grid.append(card);
    });
    renderPins();
  }
