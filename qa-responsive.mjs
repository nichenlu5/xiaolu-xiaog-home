...
try {
  ...
  console.log(`PASS responsive: ${pages.length} pages × 8 viewports; 11 game entries; wishlist regression; 7 original games; 35 achievements; v2.6 journey and life links`);
